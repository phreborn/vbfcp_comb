...
parambrAsimov_gg=workspace/lhchcg/myrep/atlas/parambr/atlas_hgamgam_asimov_parambr.root
parambrToy_gg=workspace/lhchcg/myrep/atlas/parambr/atlas_hgamgam_toy_parambr.root
parambrObs_gg=workspace/lhchcg/myrep/atlas/parambr/atlas_hgamgam_obs_parambr.root

mkdir -vp workspace/lhchcg/myrep/atlas/parambrlumi/
parambrlumiAsimov_gg=workspace/lhchcg/myrep/atlas/parambrlumi/atlas_hgamgam_asimov_parambrlumi.root
parambrlumiToy_gg=workspace/lhchcg/myrep/atlas/parambrlumi/atlas_hgamgam_toy_parambrlumi.root
parambrlumiObs_gg=workspace/lhchcg/myrep/atlas/parambrlumi/atlas_hgamgam_obs_parambrlumi.root
...
# cat cfg/lhchcg/ATLAS_add_BR_handler_gamgam_template.xml | sed "s|#INPUT#|$decoratedAsimov_gg|g" | sed "s|#OUTPUT#|$handlerAsimov_gg|g" > cfg/lhchcg/ATLAS_add_BR_handler_gamgam_asimov.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_gamgam_asimov.xml

# cat cfg/lhchcg/ATLAS_add_BR_handler_gamgam_template.xml | sed "s|#INPUT#|$decoratedToy_gg|g" | sed "s|#OUTPUT#|$handlerToy_gg|g" > cfg/lhchcg/ATLAS_add_BR_handler_gamgam_toy.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_gamgam_toy.xml

# cat cfg/lhchcg/ATLAS_add_BR_handler_gamgam_template.xml | sed "s|#INPUT#|$decoratedObs_gg|g" | sed "s|#OUTPUT#|$handlerObs_gg|g" > cfg/lhchcg/ATLAS_add_BR_handler_gamgam_obs.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_gamgam_obs.xml

# ################################ Parametrize BR in the workspace #######################################
cat cfg/lhchcg/ATLAS_param_BR_gamgam_template.xml | sed "s|#INPUT#|$handlerAsimov_gg|g" | sed "s|#OUTPUT#|$parambrAsimov_gg|g" > cfg/lhchcg/ATLAS_param_BR_gamgam_asimov.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_gamgam_asimov.xml

cat cfg/lhchcg/ATLAS_param_BR_gamgam_template.xml | sed "s|#INPUT#|$handlerToy_gg|g" | sed "s|#OUTPUT#|$parambrToy_gg|g" > cfg/lhchcg/ATLAS_param_BR_gamgam_toy.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_gamgam_toy.xml

cat cfg/lhchcg/ATLAS_param_BR_gamgam_template.xml | sed "s|#INPUT#|$handlerObs_gg|g" | sed "s|#OUTPUT#|$parambrObs_gg|g" > cfg/lhchcg/ATLAS_param_BR_gamgam_obs.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_gamgam_obs.xml

cat cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_template.xml | sed "s|#INPUT#|$handlerAsimov_gg|g" | sed "s|#OUTPUT#|$parambrlumiAsimov_gg|g" > cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_asimov.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_asimov.xml

cat cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_template.xml | sed "s|#INPUT#|$handlerToy_gg|g" | sed "s|#OUTPUT#|$parambrlumiToy_gg|g" > cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_toy.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_toy.xml

cat cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_template.xml | sed "s|#INPUT#|$handlerObs_gg|g" | sed "s|#OUTPUT#|$parambrlumiObs_gg|g" > cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_obs.xml
manager -w orgnize -x cfg/lhchcg/ATLAS_param_BR_lumi_gamgam_obs.xml
...
# # ################################ Implementing handlers in the workspace #######################################
# cat cfg/lhchcg/ATLAS_add_BR_handler_zz_template.xml | sed "s|#INPUT#|$decoratedAsimov_zz|g" | sed "s|#OUTPUT#|$handlerAsimov_zz|g" > cfg/lhchcg/ATLAS_add_BR_handler_zz_asimov.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_zz_asimov.xml

# cat cfg/lhchcg/ATLAS_add_BR_handler_zz_template.xml | sed "s|#INPUT#|$decoratedToy_zz|g" | sed "s|#OUTPUT#|$handlerToy_zz|g" > cfg/lhchcg/ATLAS_add_BR_handler_zz_toy.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_zz_toy.xml

# cat cfg/lhchcg/ATLAS_add_BR_handler_zz_template.xml | sed "s|#INPUT#|$decoratedObs_zz|g" | sed "s|#OUTPUT#|$handlerObs_zz|g" > cfg/lhchcg/ATLAS_add_BR_handler_zz_obs.xml
# manager -w orgnize -x cfg/lhchcg/ATLAS_add_BR_handler_zz_obs.xml
