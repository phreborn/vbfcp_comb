...
pois="mu_Run3Scale=1,mu=1,mu_BR_yy=1,mu_spur_SM=0,mu_ggH_SM=0,mu_VBF_SM=0,mu_spur=1,mu_ggH=1,mu_VBF_RW=1_0_5"
...
if [ ${expected} -eq 1 ];then
  ...
  pois="mu_Run3Scale=1,mu=1,mu_BR_yy=1,mu_spur_SM=0,mu_ggH_SM=0,mu_VBF_SM=0,mu_spur=1,mu_ggH=2.143,mu_VBF_RW=1_0_5"
fi
