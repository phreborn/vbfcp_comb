...
do
  ...
  # observed
  cp /scratchfs/atlas/huirun/atlaswork/VBF_CP/WSBuilder/xmlAnaWSBuilder/run/WSRun3Prosp/vbf_cp_${dgam}/vbf_cp_${dgam}.root inWS/gamgam/Observed/vbf_cp_${dgam}_mu_bkg.root
